...
Minimap:SetScript('OnLeave', function(self) UIFrameFadeOut(TidyMinimap, 6.0, TidyMinimap:GetAlpha(), 0)   end) 
...
local f = CreateFrame("Frame") 
    ...
    if event == "PLAYER_ENTERING_WORLD" then 
      UIFrameFadeOut(TidyMinimap, 6.0, TidyMinimap:GetAlpha(), 0)    
   end 
...
--'TOPRIGHT#MinimapCluster#TOPRIGHT#0#-10',
		anchor = 'topright',
		grow = 'left',
		scale = 0.7,
		borders = true,
