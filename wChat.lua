local altclickinvite	= true	--Alt點人名邀請
local fontoutline	= true	--字體輪廓
local hideurl	= true	--複製網址
local hidechatcopy	= true	--複製聊天


--防止超出螢幕
BNToastFrame:SetClampedToScreen(true)
QuickJoinToastButton:SetAlpha(.3)

--Sticky Channels, 0 off, 1 on 不鎖定密語
...
--[[社交放小地圖左上
QuickJoinToastButton:SetAlpha(.6)
QuickJoinToastButton:ClearAllPoints()
QuickJoinToastButton:SetScale(.85)
QuickJoinToastButton:SetPoint("TOPLEFT", MinimapCluster, "TOPLEFT", 0, 0)]]
--[[好友提醒挪位置
...
--隱藏聊天框
local CHTZ = CreateFrame("Button",nil,UIParent)
CHTZ:SetSize(30,30)
CHTZ.t=CHTZ:CreateTexture(nil,"BORDER")
CHTZ.t:SetTexture("Interface\\CHATFRAME\\UI-ChatIcon-Minimize-Up.blp")
CHTZ.t:SetAllPoints(CHTZ)
CHTZ:SetPoint("BOTTOM","ChatFrame1ButtonFrame","BOTTOM",0,-35)
CHTZ:Show()

CHTZ:SetScript("onclick", 
	function(self, button)
		CHTZ.t:SetTexture("Interface\\CHATFRAME\\UI-ChatIcon-Maximize-Up.blp")
...
roll:SetWidth(22);roll:SetHeight(22);roll:SetPoint("TOPLEFT",MainMenuBar,"TOPLEFT",15,80); 
